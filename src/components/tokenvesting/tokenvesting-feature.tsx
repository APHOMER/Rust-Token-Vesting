  ...
  return publicKey ? (
    <div>
      <AppHero
        title="Tokenvesting"
        subtitle={
          'Create a new Vesting account below by clicking the "Create" button. The state of a account is stored on-chain and can be manipulated by calling the program\'s methods (increment, decrement, set, and close).'
        }
      >
        <p className="mb-6">
